...
function getRoute(id)
{
	...
	$.ajax({
		type: 'GET',
		url: 'http://smarttracking.esy.es/index.php/route/find/'+ id,
		success: function (req)
		{
			$.ajax({
			type: 'GET',
			url: 'http://smarttracking.esy.es/index.php/route/location/'+ id,
			success: function (req2)
			{
				...
				$('#fecha').text(req2.location[0]['fecha'].substring(11));
